...
hook.Add("Think", "medic_npc_localply", function()
	localPly = LocalPlayer()
hook.Remove("Think", "medic_npc_localply")
end)
...
function ENT:Draw()
	...
	cam.Start3D2D(pos,ang,0.04)
		draw.RoundedBox(6,-250-2,0-2,500+4,150+4,white)
		draw.RoundedBox(6,-250,0,500,150,black)
		draw.SimpleText(lang.overhead,"medic_topText",0,75,white,1,1)
	cam.End3D2D()
end
